...
public class DroneInterface extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("RJMs attempt at Moving drone");
	    ...
	    timer = new AnimationTimer() {									// set up timer
	        public void handle(long currentNanoTime) {					// and its action when on
		            ...
		            arena.adjustDrones();								// move all drone
		            drawWorld();										// redraw the world
		            drawStatus();										// indicate where drone are
	        }
	    };
        ...
        bp.setBackground(new Background(new BackgroundFill(Color.AQUAMARINE, null, null)));
